...
(function(mod) {
  ...
  TextareaInput.prototype = copyObj({
    ...
    onContextMenu: function(e) {
      ...
      te.style.cssText = "position: fixed; width: 30px; height: 30px; top: " + (e.clientY - 5) +
        ...
        "; outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; intercepter: alpha(opacity=5);";
  ...
  // Retrieve and intercepter the old marked spans stored in a change event.
